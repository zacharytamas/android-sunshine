package com.zacharytamas.sunshine.app.sync;
...
import com.zacharytamas.sunshine.app.R;
import com.zacharytamas.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            getWeatherDataFromJson(forecastJsonStr, locationQuery, getContext());
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
                                        String locationSetting, Context context)
     ...
     */
    long addLocation(String locationSetting, String cityName, double lat, double lon, Context context) {
        // Students: First, check if the location with this city name exists in the db

        Cursor c = context.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
                null, WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?",
